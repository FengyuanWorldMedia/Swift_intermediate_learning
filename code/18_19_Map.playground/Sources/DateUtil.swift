...
extension String {
   ...
   public func toDate(_ format: DateFormatType = .isoDate) -> Date {
   ...
   public func replaceCharacters(characters: String, toSeparator: String) -> String {
    ...
    public func wipeCharacters(characters: String) -> String {
        return self.replaceCharacters(characters: characters, toSeparator: "")
    } 
}

// By 丰源天下传媒
public func formatDate(d: Date) -> String {
    let dateFormatter = DateFormatter()
